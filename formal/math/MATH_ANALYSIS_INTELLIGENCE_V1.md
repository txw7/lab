...
The first subsumption provider recognizes canonical expression equality, ordered-bound strengthening, and strict-to-nonstrict implication for the same variable.

The theorem matcher performs structural variable substitution before subsumption and classifies a matched conclusion and distinguishes already-discharged, incompatible, unknown, and genuinely new-subgoal hypotheses.
